...
#include "countdown_interfaces/action/detail/countdown__rosidl_typesupport_fastrtps_c.h"
...
#include "countdown_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Countdown_Goal__ros_msg_type = countdown_interfaces__action__Countdown_Goal;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_countdown_interfaces
size_t get_serialized_size_countdown_interfaces__action__Countdown_Goal(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name start_from
  {
    size_t item_size = sizeof(ros_message->start_from);
...
static uint32_t _Countdown_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_countdown_interfaces__action__Countdown_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_countdown_interfaces
size_t max_serialized_size_countdown_interfaces__action__Countdown_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = countdown_interfaces__action__Countdown_Goal;
    is_plain =
      (
      offsetof(DataType, start_from) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Countdown_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_countdown_interfaces__action__Countdown_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, countdown_interfaces, action, Countdown_Goal)() {
...
#include "rosidl_runtime_c/string.h"  // result_text
#include "rosidl_runtime_c/string_functions.h"  // result_text

// forward declare type support functions


using _Countdown_Result__ros_msg_type = countdown_interfaces__action__Countdown_Result;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->result_text;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: result_text
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->result_text.data) {
      rosidl_runtime_c__String__init(&ros_message->result_text);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->result_text,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'result_text'\n");
      return false;
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_countdown_interfaces
size_t get_serialized_size_countdown_interfaces__action__Countdown_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Countdown_Result__ros_msg_type * ros_message = static_cast<const _Countdown_Result__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += padding +
    ...
    (ros_message->result_text.size + 1);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_countdown_interfaces__action__Countdown_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_countdown_interfaces
size_t max_serialized_size_countdown_interfaces__action__Countdown_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = countdown_interfaces__action__Countdown_Result;
    is_plain =
      (
      offsetof(DataType, result_text) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Countdown_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_countdown_interfaces__action__Countdown_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, countdown_interfaces, action, Countdown_Result)() {
...
using _Countdown_Feedback__ros_msg_type = countdown_interfaces__action__Countdown_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_countdown_interfaces
size_t get_serialized_size_countdown_interfaces__action__Countdown_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Countdown_Feedback__ros_msg_type * ros_message = static_cast<const _Countdown_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_countdown_interfaces__action__Countdown_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_countdown_interfaces
size_t max_serialized_size_countdown_interfaces__action__Countdown_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = countdown_interfaces__action__Countdown_Feedback;
    is_plain =
      (
...
static size_t _Countdown_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_countdown_interfaces__action__Countdown_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, countdown_interfaces, action, Countdown_Feedback)() {
...
// already included above
// #include "countdown_interfaces/action/detail/countdown__functions.h"  // goal
...
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, countdown_interfaces, action, Countdown_Goal)();
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_countdown_interfaces
...
using _Countdown_SendGoal_Request__ros_msg_type = countdown_interfaces__action__Countdown_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, countdown_interfaces, action, Countdown_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_countdown_interfaces
size_t get_serialized_size_countdown_interfaces__action__Countdown_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Countdown_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _Countdown_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_countdown_interfaces__action__Countdown_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_countdown_interfaces__action__Countdown_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_countdown_interfaces
size_t max_serialized_size_countdown_interfaces__action__Countdown_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_countdown_interfaces__action__Countdown_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = countdown_interfaces__action__Countdown_SendGoal_Request;
    is_plain =
      (
...
static size_t _Countdown_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_countdown_interfaces__action__Countdown_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, countdown_interfaces, action, Countdown_SendGoal_Request)() {
...
using _Countdown_SendGoal_Response__ros_msg_type = countdown_interfaces__action__Countdown_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_countdown_interfaces
size_t get_serialized_size_countdown_interfaces__action__Countdown_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Countdown_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _Countdown_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_countdown_interfaces__action__Countdown_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_countdown_interfaces
size_t max_serialized_size_countdown_interfaces__action__Countdown_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = countdown_interfaces__action__Countdown_SendGoal_Response;
    is_plain =
      (
...
static size_t _Countdown_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_countdown_interfaces__action__Countdown_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, countdown_interfaces, action, Countdown_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, countdown_interfaces, action, Countdown_SendGoal)() {
...
using _Countdown_GetResult_Request__ros_msg_type = countdown_interfaces__action__Countdown_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_countdown_interfaces
size_t get_serialized_size_countdown_interfaces__action__Countdown_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Countdown_GetResult_Request__ros_msg_type * ros_message = static_cast<const _Countdown_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_countdown_interfaces__action__Countdown_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_countdown_interfaces
size_t max_serialized_size_countdown_interfaces__action__Countdown_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = countdown_interfaces__action__Countdown_GetResult_Request;
    is_plain =
      (
...
static size_t _Countdown_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_countdown_interfaces__action__Countdown_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, countdown_interfaces, action, Countdown_GetResult_Request)() {
...
// already included above
// #include "countdown_interfaces/action/detail/countdown__functions.h"  // result
...
using _Countdown_GetResult_Response__ros_msg_type = countdown_interfaces__action__Countdown_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, countdown_interfaces, action, Countdown_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_countdown_interfaces
size_t get_serialized_size_countdown_interfaces__action__Countdown_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Countdown_GetResult_Response__ros_msg_type * ros_message = static_cast<const _Countdown_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_countdown_interfaces__action__Countdown_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_countdown_interfaces__action__Countdown_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_countdown_interfaces
size_t max_serialized_size_countdown_interfaces__action__Countdown_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_countdown_interfaces__action__Countdown_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = countdown_interfaces__action__Countdown_GetResult_Response;
    is_plain =
      (
...
static size_t _Countdown_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_countdown_interfaces__action__Countdown_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, countdown_interfaces, action, Countdown_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, countdown_interfaces, action, Countdown_GetResult)() {
...
// already included above
// #include "countdown_interfaces/action/detail/countdown__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _Countdown_FeedbackMessage__ros_msg_type = countdown_interfaces__action__Countdown_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, countdown_interfaces, action, Countdown_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_countdown_interfaces
size_t get_serialized_size_countdown_interfaces__action__Countdown_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Countdown_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _Countdown_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_countdown_interfaces__action__Countdown_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_countdown_interfaces__action__Countdown_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_countdown_interfaces
size_t max_serialized_size_countdown_interfaces__action__Countdown_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_countdown_interfaces__action__Countdown_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = countdown_interfaces__action__Countdown_FeedbackMessage;
    is_plain =
      (
...
static size_t _Countdown_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_countdown_interfaces__action__Countdown_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, countdown_interfaces, action, Countdown_FeedbackMessage)() {
