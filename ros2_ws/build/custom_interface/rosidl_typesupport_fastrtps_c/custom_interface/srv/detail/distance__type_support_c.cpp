...
#include "custom_interface/srv/detail/distance__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // a, b
...
using _Distance_Request__ros_msg_type = custom_interface__srv__Distance_Request;
...
static uint32_t _Distance_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interface__srv__Distance_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interface__srv__Distance_Request;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
static size_t _Distance_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interface__srv__Distance_Request(
...
using _Distance_Response__ros_msg_type = custom_interface__srv__Distance_Response;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interface__srv__Distance_Response(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interface__srv__Distance_Response;
    is_plain =
      (
...
static size_t _Distance_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interface__srv__Distance_Response(
    full_bounded, is_plain, 0);
...
// already included above
// #include "custom_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "custom_interface/srv/distance.h"
