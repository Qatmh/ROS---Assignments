...
#include "custom_interface/msg/detail/person__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interface::msg::Person & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interface::msg::Person & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interface::msg::Person;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interface::msg::Person *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interface::msg::Person *>(
    untyped_ros_message);
...
get_message_type_support_handle<custom_interface::msg::Person>()
{
  return &custom_interface::msg::typesupport_fastrtps_cpp::_Person__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, msg, Person)() {
  return &custom_interface::msg::typesupport_fastrtps_cpp::_Person__handle;
}
