...
class Person(metaclass=Metaclass_Person):
    ...
    def __init__(self, **kwargs):
        ...
        self.is_student = kwargs.get('is_student', bool())
    ...
    def __eq__(self, other):
        ...
        if self.age != other.age:
            return False
        if self.is_student != other.is_student:
            return False
        return True
    ...
    def is_student(self, value):
        if __debug__:
            assert \
                ...
                "The 'is_student' field must be of type 'bool'"
