...
def generate_launch_description():
    ...
    pkg_my_world = get_package_share_directory('gazebo_example')  # Replace 'world' with your package name
    ...
    # World file path (REPLACE with your actual world file name)
    world = os.path.join(pkg_my_world, 'worlds', 'world.world')
    ...
    # Load URDF (change to xacro if needed)
    urdf_file_name = 'turtlebot3_waffle.urdf'  # Or use xacro processing if needed
